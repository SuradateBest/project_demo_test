                    ...
                    {role === "Artist" || role === "Admin" ?
                        <><div className="logo-container font-link">
                            ...
                            <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                                ...
                                <li className="nav-item li font-name-head">
                                    <Link to="/uploadimage" className="nav-links" onClick={closeMobileMenu}>
                                        UploadImage
                                    </Link>
                                </li>
                                <li className="nav-item li"
                                ...
                                >
                                    ...
                                    <label className="nav-links font-name-head" onClick={() => { closeMobileMenu(); swapPageProfile(userId) }}>
                        ...
                        </> : <><NavbarViewer role={role === "Viewer"} /></>
                    }
                </nav>
                <div className="container-search">
                    {(search.length > 0 && find.length > 0) ? (
                        find.map((contact, key) =>
                            <div className="dataResult cursor-allowed" style={{ display: find ? "block" : "none" }}
